...
const Spinners = () => {
  ...
  const { user} = useContext(UserContext);
    ...
    console.log(user,'ii')
  return (
    <div className={`loading ${isLoadingNavId ? "flex" : "hidden"}   gap-4 text-center rounded-lg z-50 absolute w-[300px] h-[50px] flex justify-center items-center  top-2 right-2   bg-gray-400`}>
