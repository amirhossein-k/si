...
export default function AddProduct() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // try {
      const payload = JSON.stringify({ name, price, html,checkbox,detailImage,imageDefult,selectedImageId,count,countproduct,priceOffer })
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-md text-black">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <Upload detailImage={detailImage} setDetailImage={setDetailImage} />
        <div>
